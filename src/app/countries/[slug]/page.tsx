    ...
    >
      <div className='w-[85%] py-8 mx-auto flex flex-col gap-16'>
        ...
        {countryInfo ? (
          <div className='flex flex-col gap-10'>
            <div className='w-full relative h-[220px]'>
              <Image
                ...
                alt={countryInfo.data.flags.alt || countryInfo.data.name.common}
                fill={true}
              />
            </div>
            <div
              className={`flex flex-col gap-6 ${
                darkTheme ? 'text-very-light-gray' : 'text-text-very-dark-blue'
              }`}
            >
                  ...
                  {bordersInfo &&
                    bordersInfo.map((border) => (
                      <Link
                        ...
                        className={`flex justify-center items-center px-4 py-2 shadow-md rounded-sm w-[90px] text-sm font-semibold truncate ${
                          darkTheme
                            ? 'bg-dark-blue text-very-light-gray'
                            : 'bg-white text-text-very-dark-blue'
                        }`}
          ...
          <div>
            Sorry No info of this country loaded, please reload the page{' '}
          </div>
        )}
      </div>
    </main>
